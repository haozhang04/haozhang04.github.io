...
<div class="hero-container">
  <div class="hero-title">ROBOCON2025</div>
  <div class="hero-badges">
    <span class="badge-item">北科马术队长</span>
    <span class="badge-item">年度优秀队长</span>
    <span class="badge-item">包揽冠亚季军</span>
    <span class="badge-item">最佳技术奖</span>
    <span class="badge-item">管理10人队伍</span>
  </div>
  <p style="color: var(--text-muted-color); max-width: 600px; margin: 0 auto; font-size: 1.1rem;">
    凭借卓越的领导力与团队协作，再次创造历史性佳绩，并连续2年获得优秀队长。
  </p>
</div>
...
{% include embed/bilibili.html id='BV12EKbzsE9M' %}
